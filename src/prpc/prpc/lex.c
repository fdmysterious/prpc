/* Generated by re2c 1.1.1 on Fri Jul 19 23:07:10 2019 */
#line 1 "src/prpc/prpc/lex.re.c"
#include "lex.h"
#include "parse.h"
...
yy2:
	++(*ptr);
#line 70 "src/prpc/prpc/lex.re.c"
	{ dst->type   = TOKEN_EOF;       return; }
#line 137 "src/prpc/prpc/lex.c"
yy4:
	++(*ptr);
yy5:
#line 69 "src/prpc/prpc/lex.re.c"
	{ dst->type   = TOKEN_ERROR;     return; }
#line 143 "src/prpc/prpc/lex.c"
yy6:
	yych = *++(*ptr);
	switch (yych) {
	case '\t':
...
yy8:
#line 72 "src/prpc/prpc/lex.re.c"
	{ dst->type   = TOKEN_SEPARATOR; return; }
#line 154 "src/prpc/prpc/lex.c"
yy9:
	yyaccept = 0;
	yych = *(YYMARKER = ++(*ptr));
	switch (yych) {
...
yy12:
#line 125 "src/prpc/prpc/lex.re.c"
	{
...
yy17:
#line 84 "src/prpc/prpc/lex.re.c"
	{
            dst->type      = TOKEN_INT;
            dst->begin     = start;
            dst->end       = (*ptr);
...
yy26:
#line 61 "src/prpc/prpc/lex.re.c"
	{
...
yy30:
#line 102 "src/prpc/prpc/lex.re.c"
	{
...
yy35:
	...
	name = yyt2;
	sep = yyt2 - 1;
#line 111 "src/prpc/prpc/lex.re.c"
	{
...
yy38:
#line 74 "src/prpc/prpc/lex.re.c"
	{
...
yy40:
#line 93 "src/prpc/prpc/lex.re.c"
	{
            dst->type         = TOKEN_BOOLEAN;
            dst->begin        = start;
            dst->end          = (*ptr);
...
yy43:
	++(*ptr);
#line 71 "src/prpc/prpc/lex.re.c"
	{ dst->type   = TOKEN_EOL;       return; }
#line 854 "src/prpc/prpc/lex.c"
}
#line 132 "src/prpc/prpc/lex.re.c"
