/* Generated by re2c 1.1.1 on Fri Jul 19 23:04:18 2019 */
#line 1 "src/example/cmds.re.c"
#include "cmds.h"
#include <stdio.h>
#include <prpc/lex.h>
#include <prpc/msg.h>
...
yy2:
	++(*ptr);
yy3:
#line 62 "src/example/cmds.re.c"
	{ return NULL;               }
#line 76 "src/example/cmds.c"
yy4:
	yych = *(YYMARKER = ++(*ptr));
	switch (yych) {
	case 'U':
...
yy17:
	++(*ptr);
#line 63 "src/example/cmds.re.c"
	{ return prpc_cmd_has;       }
#line 173 "src/example/cmds.c"
yy19:
	yych = *++(*ptr);
	switch (yych) {
	case 'O':
...
yy24:
	++(*ptr);
#line 65 "src/example/cmds.re.c"
	{ return prpc_cmd_funky;     }
#line 219 "src/example/cmds.c"
yy26:
	++(*ptr);
#line 64 "src/example/cmds.re.c"
	{ return prpc_cmd_hello;     }
#line 224 "src/example/cmds.c"
yy28:
	yych = *++(*ptr);
	switch (yych) {
	case 'A':
...
yy32:
	++(*ptr);
#line 66 "src/example/cmds.re.c"
	{ return prpc_cmd_replicate; }
#line 260 "src/example/cmds.c"
}
#line 67 "src/example/cmds.re.c"
